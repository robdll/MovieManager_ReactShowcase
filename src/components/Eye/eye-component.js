...
const Eye = function(props) {
  const color = props.seen ? "#aad045" : "#888";
  return (
    <>
      <svg className={style.svg} id="icon_visto" onClick={ () => props.action(props.movie) } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 86.917 77.47">
